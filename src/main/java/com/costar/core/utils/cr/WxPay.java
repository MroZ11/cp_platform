 ...
 */
public class WxPay implements ChannelPayAccessAdapter {
    ...
    @Override
    public Object doChannelPay(ChargeRequest charge) {
        WXPay wxpay = null;
        ...
        } else if (charge.getChannel().equals("wx_pub") || charge.getChannel().equals("wx_pub_qr")) {
            //微信 JSAPI 支付  在公众内调用          //微信 Native 支付,生成二维码给用户扫码
